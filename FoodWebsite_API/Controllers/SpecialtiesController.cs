...
namespace FoodWebsite_API.Controllers
{
    ...
    public class SpecialtiesController : ControllerBase
    {
        ...
        //thêm lọc tìm kiếm
        // Nếu có query => lọc, không thì trả tất cả
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Specialty>>> GetSpecialties([FromQuery] string? query)
        {
            ...
            return await _context.Specialties
                .Where(s => s.Name.ToLower() == query.ToLower())
                .ToListAsync();
        }
